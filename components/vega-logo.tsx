...
/*
  Logo inline a partir do ativo vetorial original (logo-vega.svg).
  Os chevrons mantem o token #FF3900; a marca nominal herda currentColor,
  o que atende a regra de "versao de alto contraste adequada ao fundo"
  sem redesenhar o logotipo.
*/
export default function VegaLogo({ className, title = "Vega Soluções Empresariais" }: Props) {
  return (
    <svg
      viewBox="0 0 1000 305.22"
      className={className}
