const message = "Olá! Quero saber mais sobre os serviços da Vega."
...
export const whatsappContactUrl = `https://wa.me/${whatsappNumber}?text=${encodeURIComponent(message)}`
